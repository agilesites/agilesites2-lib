...
/**
 * Writes a DOM tree to a given Writer. warning: this utility currently does not
...
public class DOMElementWriter {
	...
	public static class XmlNamespacePolicy {
		 ...
		 */
		public static final XmlNamespacePolicy IGNORE = new XmlNamespacePolicy(
				false, false);

		/**
		 * Ignores namespaces for attributes.
		 */
		public static final XmlNamespacePolicy ONLY_QUALIFY_ELEMENTS = new XmlNamespacePolicy(
				true, false);

		/**
		 * Qualifies namespaces for elements and attributes.
		 */
		public static final XmlNamespacePolicy QUALIFY_ALL = new XmlNamespacePolicy(
				true, true);
	...
	/**
	 * Create an element writer. The ?xml? declaration will be included,
	 * namespaces ignored.
	 */
	 ...
	 * &lt;?xml version='1.0' encoding='UTF-8'?&gt; if the xmlDeclaration field
	 * is true. The indent number is set to 0 and a 2-space indent.
	 * 
	 * @param root
	...
	public void openElement(Element element, Writer out, int indent,
			String indentWith) throws IOException {
	 ...
	 */
	public void openElement(Element element, Writer out, int indent,
			String indentWith, boolean hasChildren) throws IOException {
	 ...
	 * 
	 * <p>
	 * Also ensure that we are not including an <code>]]&gt;</code> marker by
	 * replacing that sequence with <code>&amp;#x5d;&amp;#x5d;&amp;gt;</code>.
	 * </p>
	 * 
	 * <p>
	 * See XML 1.0 2.2 <a
	 * href="http://www.w3.org/TR/1998/REC-xml-19980210#charsets">
	 * http://www.w3.org/TR/1998/REC-xml-19980210#charsets</a> and 2.7 <a
	 * href="http://www.w3.org/TR/1998/REC-xml-19980210#sec-cdata-sect"
	 * >http://www.w3.org/TR/1998/REC-xml-19980210#sec-cdata-sect</a>.
	 * </p>
	 * 
	 * @param value
