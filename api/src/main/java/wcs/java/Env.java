...
public class Env extends wcs.core.ICSProxyJ implements Content, wcs.api.Env {
    ...
    public void init(ICS ics) {
        ...
        config = (wcs.api.Config)wcs.core.WCS.getConfig(ics);
        router = (wcs.api.Router)wcs.core.WCS.getRouter(ics);
    ...
    /**
     * Read a field of a list as a string
     */
    @Override
    ...
    /**
     * Read the field in the nth row of a list as a string
     *
     * @param list
     * @param row
     * @param field
    ...
    /**
     * Read in the nth row of a list the field "value" as a string
     *
     * @param list
     * @param row
     * @return
