...
public static Sqlexp sqlexp() {
  ...
  private FTValList args = new FTValList();
  private String output;
  public Ifempty set(String name, String value) { args.setValString(name,value); return this; }
 public Ifempty variable(String val) { args.setValString("VARIABLE", val); return this; } 
      
 public Ifempty list(String val) { args.setValString("LIST", val); return this; } 
      
  public Ifempty() { }
  public int run(ICS ics) { 
      ics.runTag("ICS.IFEMPTY", args); 
      log.trace(ftValList2String("Ifempty", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
...
public static Ifempty ifempty() {
  return new Ifempty();
}


  public static class Ifnotempty {
  private FTValList args = new FTValList();
  private String output;
  public Ifnotempty set(String name, String value) { args.setValString(name,value); return this; }
 public Ifnotempty variable(String val) { args.setValString("VARIABLE", val); return this; } 
      
 public Ifnotempty list(String val) { args.setValString("LIST", val); return this; } 
      
  public Ifnotempty() { }
  public int run(ICS ics) { 
      ics.runTag("ICS.IFNOTEMPTY", args); 
      log.trace(ftValList2String("Ifnotempty", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Ifnotempty set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Ifnotempty ifnotempty() {
