...
public static Setlocale setlocale() {
  ...
  private FTValList args = new FTValList();
  private String output;
  public Gettimezone set(String name, String value) { args.setValString(name,value); return this; }
 public Gettimezone name(String val) { args.setValString("NAME", val); return this; } 
      
 public Gettimezone varname(String val) { args.setValString("VARNAME", val); return this; } 
      
  public Gettimezone() { }
  public int run(ICS ics) { 
      ics.runTag("CCUSER.GETTIMEZONE", args); 
      log.trace(ftValList2String("Gettimezone", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Gettimezone set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Gettimezone gettimezone() {
  ...
  private FTValList args = new FTValList();
  private String output;
  public Settimezone set(String name, String value) { args.setValString(name,value); return this; }
 public Settimezone name(String val) { args.setValString("NAME", val); return this; } 
      
 public Settimezone value(String val) { args.setValString("VALUE", val); return this; } 
      
  public Settimezone() { }
  public int run(ICS ics) { 
      ics.runTag("CCUSER.SETTIMEZONE", args); 
      log.trace(ftValList2String("Settimezone", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Settimezone set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Settimezone settimezone() {
