...
public class NameTag  {    
  private static Log log = Log.getLog(NameTag.class);  
...
public static Get get() {
  ...
  public static class Makechild {
  private FTValList args = new FTValList();
  private String output;
  public Makechild set(String name, String value) { args.setValString(name,value); return this; }
 public Makechild context(String val) { args.setValString("CONTEXT", val); return this; } 
      
 public Makechild output(String val) { args.setValString("OUTPUT", val); return this; } 
      
  public Makechild() { }
  public int run(ICS ics) { 
      ics.runTag("NAME.MAKECHILD", args); 
      log.trace(ftValList2String("Makechild", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Makechild set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Makechild makechild() {
