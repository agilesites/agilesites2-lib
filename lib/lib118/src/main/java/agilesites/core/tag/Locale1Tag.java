...
public class Locale1Tag  {    
  private static Log log = Log.getLog(Locale1Tag.class);  
 ...
 public Argument value(String val) { args.setValString("VALUE", val); return this; } 
  ...
  public int run(ICS ics) { 
      ics.runTag("LOCALE1.ARGUMENT", args); 
...
public static Argument argument() {
 ...
 public Create varname(String val) { args.setValString("VARNAME", val); return this; } 
      
 public Create language(String val) { args.setValString("LANGUAGE", val); return this; } 
      
 public Create country(String val) { args.setValString("COUNTRY", val); return this; } 
      
 public Create localename(String val) { args.setValString("LOCALENAME", val); return this; } 
      
  public Create() { }
  public int run(ICS ics) { 
      ics.runTag("LOCALE1.CREATE", args); 
