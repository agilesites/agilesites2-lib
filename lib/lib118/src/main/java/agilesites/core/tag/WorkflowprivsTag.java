...
public static Getallprivs getallprivs() {
  ...
  public static class Getpriv {
  private FTValList args = new FTValList();
  private String output;
  public Getpriv set(String name, String value) { args.setValString(name,value); return this; }
 public Getpriv name(String val) { args.setValString("NAME", val); return this; } 
      
 public Getpriv role(String val) { args.setValString("ROLE", val); return this; } 
      
 public Getpriv functionid(String val) { args.setValString("FUNCTIONID", val); return this; } 
      
 public Getpriv objvarname(String val) { args.setValString("OBJVARNAME", val); return this; } 
      
  public Getpriv() { }
  public int run(ICS ics) { 
      ics.runTag("WORKFLOWPRIVS.GETPRIV", args); 
      log.trace(ftValList2String("Getpriv", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
