...
public class SystemTag  {    
  private static Log log = Log.getLog(SystemTag.class);  
 ...
 public Argument value(String val) { args.setValString("VALUE", val); return this; } 
  ...
  public int run(ICS ics) { 
      ics.runTag("SYSTEM.ARGUMENT", args); 
...
public static Argument argument() {
  ...
  private FTValList args = new FTValList();
  private String output;
  public Gc set(String name, String value) { args.setValString(name,value); return this; }

  public Gc() { }
  public int run(ICS ics) { 
      ics.runTag("SYSTEM.GC", args); 
      log.trace(ftValList2String("Gc", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
