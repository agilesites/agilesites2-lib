...
public static Getassigneduserid getassigneduserid() {
  ...
  public static class Getassigneduserrole {
  private FTValList args = new FTValList();
  private String output;
  public Getassigneduserrole set(String name, String value) { args.setValString(name,value); return this; }
 public Getassigneduserrole name(String val) { args.setValString("NAME", val); return this; } 
      
 public Getassigneduserrole varname(String val) { args.setValString("VARNAME", val); return this; } 
      
  public Getassigneduserrole() { }
  public int run(ICS ics) { 
      ics.runTag("WORKFLOWASSIGNMENT.GETASSIGNEDUSERROLE", args); 
      log.trace(ftValList2String("Getassigneduserrole", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Getassigneduserrole set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Getassigneduserrole getassigneduserrole() {
  return new Getassigneduserrole();
}
