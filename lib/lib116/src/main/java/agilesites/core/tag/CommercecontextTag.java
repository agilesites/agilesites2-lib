...
public static Getratings getratings() {
 ...
 public Getrecommendations engine(String val) { args.setValString("ENGINE", val); return this; } 
      
 public Getrecommendations engineparameters(String val) { args.setValString("ENGINEPARAMETERS", val); return this; } 
...
public static Getrecommendations getrecommendations() {
  ...
  private FTValList args = new FTValList();
  private String output;
  public Inform set(String name, String value) { args.setValString(name,value); return this; }
 public Inform list(String val) { args.setValString("LIST", val); return this; } 
      
 public Inform engine(String val) { args.setValString("ENGINE", val); return this; } 
      
 public Inform engineparameters(String val) { args.setValString("ENGINEPARAMETERS", val); return this; } 
      
  public Inform() { }
  public int run(ICS ics) { 
      ics.runTag("COMMERCECONTEXT.INFORM", args); 
      log.trace(ftValList2String("Inform", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
...
public static Getsegments getsegments() {
  ...
  public static class Setsegments {
  private FTValList args = new FTValList();
  private String output;
  public Setsegments set(String name, String value) { args.setValString(name,value); return this; }
 public Setsegments names(String val) { args.setValString("NAMES", val); return this; } 
      
  public Setsegments() { }
  public int run(ICS ics) { 
      ics.runTag("COMMERCECONTEXT.SETSEGMENTS", args); 
      log.trace(ftValList2String("Setsegments", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Setsegments set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Setsegments setsegments() {
  return new Setsegments();
}
 ...
 public Getsinglerecommendation engine(String val) { args.setValString("ENGINE", val); return this; } 
      
 public Getsinglerecommendation engineparameters(String val) { args.setValString("ENGINEPARAMETERS", val); return this; } 
...
public static Setsegmentcutoff setsegmentcutoff() {
  ...
  public static class Isuserinsegment {
  private FTValList args = new FTValList();
  private String output;
  public Isuserinsegment set(String name, String value) { args.setValString(name,value); return this; }
 public Isuserinsegment segmentid(String val) { args.setValString("SEGMENTID", val); return this; } 
      
 public Isuserinsegment varname(String val) { args.setValString("VARNAME", val); return this; } 
      
  public Isuserinsegment() { }
  public int run(ICS ics) { 
      ics.runTag("COMMERCECONTEXT.ISUSERINSEGMENT", args); 
      log.trace(ftValList2String("Isuserinsegment", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Isuserinsegment set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Isuserinsegment isuserinsegment() {
  return new Isuserinsegment();
}
