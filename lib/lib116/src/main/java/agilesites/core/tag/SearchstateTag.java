...
public static Addsimplestandardconstraint addsimplestandardconstraint() {
  ...
  public static class Addhasancestorconstraint {
  private FTValList args = new FTValList();
  private String output;
  public Addhasancestorconstraint set(String name, String value) { args.setValString(name,value); return this; }
 public Addhasancestorconstraint name(String val) { args.setValString("NAME", val); return this; } 
      
 public Addhasancestorconstraint bucket(String val) { args.setValString("BUCKET", val); return this; } 
      
 public Addhasancestorconstraint assettype(String val) { args.setValString("ASSETTYPE", val); return this; } 
      
 public Addhasancestorconstraint assetid(String val) { args.setValString("ASSETID", val); return this; } 
      
 public Addhasancestorconstraint immediateonly(String val) { args.setValString("IMMEDIATEONLY", val); return this; } 
      
  public Addhasancestorconstraint() { }
  public int run(ICS ics) { 
      ics.runTag("SEARCHSTATE.ADDHASANCESTORCONSTRAINT", args); 
      log.trace(ftValList2String("Addhasancestorconstraint", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Addhasancestorconstraint set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Addhasancestorconstraint addhasancestorconstraint() {
  return new Addhasancestorconstraint();
}


  public static class Addhasdescendantconstraint {
  private FTValList args = new FTValList();
  private String output;
  public Addhasdescendantconstraint set(String name, String value) { args.setValString(name,value); return this; }
 public Addhasdescendantconstraint name(String val) { args.setValString("NAME", val); return this; } 
      
 public Addhasdescendantconstraint bucket(String val) { args.setValString("BUCKET", val); return this; } 
      
 public Addhasdescendantconstraint assettype(String val) { args.setValString("ASSETTYPE", val); return this; } 
      
 public Addhasdescendantconstraint assetid(String val) { args.setValString("ASSETID", val); return this; } 
      
 public Addhasdescendantconstraint immediateonly(String val) { args.setValString("IMMEDIATEONLY", val); return this; } 
      
  public Addhasdescendantconstraint() { }
  public int run(ICS ics) { 
      ics.runTag("SEARCHSTATE.ADDHASDESCENDANTCONSTRAINT", args); 
      log.trace(ftValList2String("Addhasdescendantconstraint", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Addhasdescendantconstraint set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Addhasdescendantconstraint addhasdescendantconstraint() {
  return new Addhasdescendantconstraint();
}
...
public static Duplicate duplicate() {
 ...
 public Findconstraint assettypevarname(String val) { args.setValString("ASSETTYPEVARNAME", val); return this; } 
      
 public Findconstraint assetidvarname(String val) { args.setValString("ASSETIDVARNAME", val); return this; } 
...
public static Addlikeconstraint addlikeconstraint() {
  ...
  public static class Contentquerysearch {
  private FTValList args = new FTValList();
  private String output;
  public Contentquerysearch set(String name, String value) { args.setValString(name,value); return this; }
 public Contentquerysearch name(String val) { args.setValString("NAME", val); return this; } 
      
 public Contentquerysearch assetname(String val) { args.setValString("ASSETNAME", val); return this; } 
      
 public Contentquerysearch maxresults(String val) { args.setValString("MAXRESULTS", val); return this; } 
      
 public Contentquerysearch sortfield(String val) { args.setValString("SORTFIELD", val); return this; } 
      
 public Contentquerysearch sortorder(String val) { args.setValString("SORTORDER", val); return this; } 
      
  public Contentquerysearch() { }
  public int run(ICS ics) { 
      ics.runTag("SEARCHSTATE.CONTENTQUERYSEARCH", args); 
      log.trace(ftValList2String("Contentquerysearch", args));
      return ics.GetErrno(); 
  }
  public String eval(ICS ics, String output) {
	  String tmp = tmp();
  ...
  public Contentquerysearch set(Arg ... _args) {
	  for(Arg arg: _args) {
		  args.setValString(arg.name, arg.value);
	  }
	  return this;
...
public static Contentquerysearch contentquerysearch() {
  return new Contentquerysearch();
}
