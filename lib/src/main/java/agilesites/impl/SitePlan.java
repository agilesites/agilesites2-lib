...
import agilesites.core.tag.SiteplanTag;
import COM.FutureTense.Interfaces.ICS;

import java.util.LinkedList;
import java.util.List;

public class SitePlan implements agilesites.api.SitePlan {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see agilesites.impl.ISitePlan#current()
	 */
	@Override
	public Id current() {
		return currentId;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see agilesites.impl.ISitePlan#goTo(agilesites.core.Id)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see agilesites.impl.ISitePlan#children()
	 */
	@Override
	public Id[] children() {
		if (log.trace())
	 ...
	 * (non-Javadoc)
	 * 
	 * @see agilesites.impl.ISitePlan#path()
	 */
	@Override
	public Id[] path() {
		if (log.trace())
