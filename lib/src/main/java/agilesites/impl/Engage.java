...
import agilesites.core.tag.CommercecontextTag;
import agilesites.core.tag.VdmTag;
...
public class Engage {
	...
	private agilesites.api.Env env;
	private ICS ics;

	private Engage() {
	}

	private void setEnv(agilesites.api.Env e) {
		this.env = e;
		this.ics = e.ics();
	}
	 ...
	 * @return
	 */
	public static Engage getInstance(agilesites.api.Env e) {
		if (instance == null)
			instance = new Engage();
		instance.setEnv(e);
		return instance;
	...
	public List<Id> getRecommended(agilesites.api.Asset a, Arg... args) {
