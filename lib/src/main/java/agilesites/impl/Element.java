...
import agilesites.util.StringUtils;
 ...
 * 
 */
public abstract class Element implements agilesites.api.Element {
	 ...
	 * @return
	 */
	abstract public String apply(agilesites.api.Env e);
