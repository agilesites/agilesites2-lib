...
import static agilesites.Api.ifn;
import static agilesites.Api.nn;
...
import agilesites.core.tag.AssetsetTag;
...
public class Asset extends AssetBase implements agilesites.api.Asset, agilesites.api.Content {
	 ...
	 * 
	 */
	public agilesites.api.Asset getAsset(String attribute, String type) {
	 ...
	 */
	public agilesites.api.Asset getAsset(String attribute, String type, int i) {
	 ...
	 */
	@Override
	public agilesites.api.Asset getAsset(String attribute, String type, AssetDeps deps) {
	 ...
	 */
	@Override
	public agilesites.api.Asset getAsset(String attribute, int i, String type,
			AssetDeps deps) {
	...
	public String getBlobUrl(String attribute, int pos, String mimeType,
		...
		agilesites.api.Config bcfg = e.getConfig();
	...
	private String getBlobMimetype(String filename) {
		...
		agilesites.core.tag.IcsTag.selectto().table("mimetype").what("mimetype")
