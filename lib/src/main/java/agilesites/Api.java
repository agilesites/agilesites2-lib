 ...
 * 
 * You need to import static agilesites.core.Common.* to use them.
 * 
 * @author msciab
 * 
 */
public class Api {
	...
	public static Env env(ICS ics) {
		//return agilesites.core.WCS.getEnv(ics, "agilesites.impl.Env");
		return new agilesites.impl.Env(ics);
	}
	/**
