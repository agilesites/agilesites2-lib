...
//	}
	 ...
	 * @return
	 */
//	public static agilesites.api.Env getEnv(ICS ics, String className) {
//		try {
//			agilesites.api.Env env = (agilesites.api.Env) Dispatcher.getDispatcher(ics)
