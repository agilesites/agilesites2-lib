...
public class MimeTypes {
	...
	public static HashMap<String, String> mimeTypeByExt = new HashMap<String, String>() {
		{
			...
			// .mc$
			// application/x-magic-cap-package-1put("0",".mcd 	application/mcad");
	...
	public static String mimeType(String filename) {
		...
		String res = mimeTypeByExt.get(ext);
		if (res == null)
