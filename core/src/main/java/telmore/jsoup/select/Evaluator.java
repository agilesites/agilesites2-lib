package telmore.jsoup.select;

import telmore.jsoup.helper.Validate;
import telmore.jsoup.nodes.Comment;
import telmore.jsoup.nodes.Document;
import telmore.jsoup.nodes.DocumentType;
import telmore.jsoup.nodes.Element;
import telmore.jsoup.nodes.Node;
import telmore.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<telmore.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (telmore.jsoup.nodes.Attribute attribute : values) {
