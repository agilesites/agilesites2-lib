...
import telmore.jsoup.parser.Tag;
import telmore.jsoup.select.*;
...
public class Element extends Node {
     ...
     * </ul>
     * <p/>
     * See the query syntax documentation in {@link telmore.jsoup.select.Selector}.
     *
     * @param cssQuery a {@link Selector} CSS-like query
     * @return elements that match the query (empty if none match)
     * @see telmore.jsoup.select.Selector
     */
